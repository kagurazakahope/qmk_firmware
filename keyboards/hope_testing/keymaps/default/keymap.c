...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_fullsize_ansi(
             KC_WBAK, KC_WSTP, KC_WREF, KC_WFWD,    KC_MRWD, KC_MPLY, KC_MFFD,    KC_CALC, KC_MYCM, KC_MAIL,
KC_ESC,   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,    KC_PSCR, KC_SCRL, KC_PAUS,   KC_NUM, KC_PSLS, KC_PAST, KC_PMNS,
...
KC_CAPS_LOCK, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,   KC_ENTER,                                KC_P1,  KC_P2,   KC_P3,   KC_PENT,
KC_LEFT_SHIFT,  KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RIGHT_SHIFT,          KC_UP,                  KC_P0,       KC_PDOT,
KC_LCTL, MO(_FN), KC_LWIN, KC_LALT,    KC_SPACE,         KC_RALT,   KC_RWIN,   KC_APP,   KC_RCTL,   KC_LEFT, KC_DOWN, KC_RIGHT
    ),

    [_FN] = LAYOUT_fullsize_ansi(
                                  _______, _______, _______, _______,   _______, _______, _______,   _______, _______, _______,
QK_RBT,        _______, _______, _______, _______,    _______, _______, _______, _______,    _______, _______, _______, _______,   _______, _______, _______,   _______, _______, _______, _______,
